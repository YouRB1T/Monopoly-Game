...
import com.monopoly.websocket.message.response.sessoin.ResponseWebSocketMessageSession;
...
public class GameWebsocketHandler implements WebSocketHandler {
    ...
    public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {
        ...
        ResponseGameHandlerMessage response = dtoMapper.mapToResponseHandlerMessage(dtoResponse, requestMessage);
